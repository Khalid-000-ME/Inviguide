      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-3 bg-black text-white rounded-2xl p-2 h-14">
              <TabsTrigger
                value="url"
                className="rounded-xl h-10 text-base font-medium transition-all duration-200 data-[state=active]:bg-white data-[state=active]:text-black data-[state=active]:shadow-sm hover:bg-gray-800 data-[state=active]:hover:bg-white"
              >
                URL Input
              </TabsTrigger>
              <TabsTrigger
